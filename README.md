...
### 1. mimi connect
スマートフォンの位置情報や音声入力をもとに、クラウド経由で家のロボットに指示を送り、行動させることができる生活支援アプリです。  
外出中のユーザーの場所や状況に応じて、家にいるロボットが自律的に生活支援を行うことを目指しました。

- **担当**: バックエンド開発、ロボット側の処理、iOS対応、位置情報取得機能
- **技術**: Flutter, Firebase, Cloud Text-to-Speech API
- **実績**: コンテスト2位入賞
- **説明スライド**: [Canva](https://www.canva.com/design/DAGmXM9VOcQ/wGKnHrUoGK8npFWy14MOQA/edit)

### 2. ChatGPTを活用した自然言語からロボットが命令を理解するROSモジュール
人が話し言葉で出した指示を、ロボットが理解して自律的に行動できるようにするためのモジュールです。  
「部屋を片付けて」「この人を案内して」などのあいまいな指示を、ChatGPTを使って解釈し、ロボット操作で使用されるROSというミドルウェア上で動作できるよう、どこに動くか・何をするかといった情報をコードに変換できるようにしました。

- **担当**: 自然言語解釈・ROS連携モジュール開発
- **技術**: ChatGPT, ROS
- **GitHub**: [command_understanding](https://github.com/naminamina/command_understanding)

### 3. ロボットの「ジョン」とアプリ「こそこそ」
